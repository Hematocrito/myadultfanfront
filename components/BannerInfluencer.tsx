      ...
      <div className="absolute w-full bottom-1">
        <div className="flex flex-col justify-start w-full text-white px-3">
          ...
          <div className="flex md:w-full">
            <button className="border-2 border-white bg-white text-gray-400 font-extrabold shadow-md text-center rounded-md md:rounded-md w-6/12 md:w-2/12 px-3 text-xs md:text-sm py-1 md:py-2 mb-2">
              {txtBI3}
            </button>
            <button
              onClick={() => openModal('modal')}
              className="border-2 border-blue-450 bg-blue-450 font-extrabold shadow-md text-center rounded-md md:rounded-md w-3/12 md:w-2/12 px-3 text-xs md:text-sm py-1 md:py-2 mb-2 ml-2"
            >
              {txtBI4}
            </button>
            {/* </div> */}
