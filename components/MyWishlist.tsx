...
export const MyFavourite = (props: { admin: "model" | "fans" }) => {
    return (
        <section>
            <NavbarUsr />
            <div className='w-full'>
                <div className='w-4/5 m-auto mt-20 font-sans '>
                    <h1 className='font-base text-2xl font-semibold mb-4'>My Wishlist</h1>
                    <div className='grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-x-2 gap-y-10 mb-20 '>
                        <div>
                            ...
                            <h1 className='text-center font-bold text-xl text-gray-500'>Buy for $16.00</h1>
                        </div>
                        <div>
                            <div className='h-[250px] relative '>
                                <Image src={modelImage} className='rounded-xl' alt="1" layout='fill' objectFit='cover' />
