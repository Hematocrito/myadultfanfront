  ...
  return (
    <div className="my-3">
      ...
      <div className="w-full">
        <select
          {...register(fieldName)}
          className={`w-full px-2 py-2 bg-transparent text-base font-semibold  rounded-md border outline-none text-gray-600 border-blue-450 focus:ring-2 focus-within:ring-blue-250
