...
const LoginModel = (props: { login: "model" | "fans" }) => {
  ...
  const handleSubmit = async (event:any) => {
    ...
    const endpoint = 'https://api-temp.myadultfan.com/auth/login/email'
  ...
  <div>
    <Navbar />
    <PublicContainer>      
      <h2 className="text-blue-450 text-xs md:text-xl font-extrabold font-lemon-milk text-center mt-2">
        INFLUENCER
      </h2>
