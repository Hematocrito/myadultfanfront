    ...
    <div>
      <div className='flex items-center sm:gap-3 gap-2 ' >                            
          <div className="relative rounded-full w-[112px]  md:w-40 h-[112px] lg:w-[179px] lg:h-[179px] md:h-40 border-4 border-blue-450 md:mb-8 md:ml-5 mb-0 ml-0 ">
              <img className="relative border-[2px] border-white rounded-full p-0.5 lg:w-[170px] lg:h-[170px] md:w-[175px] md:h-[155px] w-56 h-49" src={foto} />
          ...
          <span className='font-bold sm:text-3xl text-white text-xl'>{user}</span>
      </div>
