...
export default function DesplgMobile() {
    return(
        <div>
            <button className="font-myriad font-medium text-blue-450 mx-5 mt-5" onClick={reenviarEN}>
                English
            </button><br/>
            <button className="font-myriad font-medium text-blue-450 mx-5 mt-5" onClick={reenviarES}>
                Español
            </button><br/>    
            <button className="font-myriad font-medium text-blue-450 mx-5 mt-5" onClick={reenviarPT}>
                Português
            </button><br/>    
            <button className="font-myriad font-medium text-blue-450 mx-5 mt-5" onClick={reenviarRU}>
                Русский
            </button><br/>    
        </div>        
    );
