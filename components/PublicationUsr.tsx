...
import PublicHeadUsr from './PublicHeadUsr';


export default function PublicationUsr({ file }: any) {
    ...
    <>
      ...
      <div className="flex flex-col mb-8 md:mt-2">
        <div className="w-full h-60 sm:h-96 relative">
          ...
          />
          {isImage && isSubscribe && (
            <div className="absolute flex flex-col justify-center w-full text-white md:top-36 top-20">
          ...
          {isVideo && (
            <>
              {isPayment && (
                <div className="absolute flex justify-center w-full md:top-36 top-20">
                  <Image src={'/assets/img/MALE.png'} height={80} width={80} alt="1" />
                </div>
              )}
              {isSubscribe && (
                <div className="absolute flex flex-col justify-center w-full text-white md:top-36 top-20">
