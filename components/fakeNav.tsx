...
export const Navbar = ({ user }: any) => {
  ...
  console.log(user);
  return (
    <nav className="flex relative h-8 md:h-14 z-50 text-white">
      <div className="w-2/5 sm:w-3/6 lg:w-4/12 flex justify-center items-center bg-white pl-[16px] md:pl-[24px]">
                ...
                >
                  ...
                  <ul className="w-full my-10">
                    ...
                    <li className="py-1 pl-3">
                      <Link href={"#"}>
                        <a className="text-blue-450">English</a>
                      </Link>
                    </li>
                    <li className="py-1 pl-3">
                      <Link href={"#"}>
                        <a className="text-blue-450">Español</a>
                      </Link>
                    </li>
                    <li className="py-1 pl-3">
                      <Link href={"#"}>
                        <a className="text-blue-450">Português</a>
                      </Link>
                    </li>
                    <li className="py-1 pl-3">
                      <Link href={"#"}>
                        <a className="text-blue-450">Pусский</a>
                      </Link>
                    </li>
                  </ul>
                </div>
