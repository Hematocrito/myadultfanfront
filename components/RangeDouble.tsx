    ...
    <div className="flex flex-col w-full">
      <div className="flex justify-between items-center my-1">
        <div className="rounded-dm">
          <span className="font-semibold text-base">Price up to</span>
          {/* <input
        ...
        <div className="rounded-dm">
          ...
          <input
            ...
            type="number"
            value={maxValue}
            className="w-24 text-right font-semibold text-base"
          />
        </div>
      </div>
      ...
      <div className="mb-4">
        ...
        <div className="range-input relative">
          ...
          <input
            type="range"
            onChange={(e)=>{handleMax(e);setFilter({...filter,["price"]:e.target.value})}}
            value={maxValue}
            min={min}
            step={step}
            max={max}
