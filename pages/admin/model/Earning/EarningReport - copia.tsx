                ...
                <div className='w-4/5 flex-1 m-auto mt-28 font-sans'>
                    ...
                    <div className='flex mt-5 w-full justify-between gap-4 sm:gap-0 overflow-scroll md:overflow-visible'>
                        <div className='flex gap-5'>
                            ...
                            <select className='border-gray-400 rounded-lg border-[1px] p-3 h-[53px] self-end' name="" id="">
                            ...
                            <div className='grid grid-cols-2 gap-4'>
                                <div className='flex flex-col'>
                                    ...
                                    <input className='text-gray-400 border-gray-400 rounded-lg border-[1px] p-3' type="date" id='startdate' />
                                </div>
                                <div className='flex flex-col'>
                                    <label className='text-gray-400' htmlFor="enddate">End Date</label>
                                    <input className=' text-gray-400 border-gray-400 rounded-lg border-[1px] p-3' type="date" id='enddate' />
                                </div>
                            </div>
                            <button className='h-[54px] self-end bg-blue-450 rounded-lg text-white font-semibold w-24'>Search</button>
                        </div>
                    </div>
                    <div className='mt-5 flex justify-between overflow-scroll md:overflow-visible'>
                        <div>
                            <h1 className='text-gray-500 text-center text-lg p-1'>Total Gross Price</h1>
                            <h1 className='text-gray-500 text-center text-3xl font-bold'>$85.90</h1>
                        </div>
                        <div>
                            <h1 className='text-gray-500 text-center text-lg p-1'>Admin earned</h1>
                            <h1 className='text-gray-500 text-center text-3xl font-bold'>$42.95</h1>
                        </div>
                        <div>
                            <h1 className='text-gray-500 text-center text-lg p-1'>Performer earned</h1>
                            <h1 className='text-gray-500 text-center text-3xl font-bold'>$42.95</h1>
                        </div>
                    </div>
