...
const PhotosGalleryList = dynamic(
  () => import('components/PhotosGalleryList'),
  { loading: () => <p>Loading ...</p> }
)

export default function Photos({ models }: any) {
  return (
    <>
      <NavbarMod />
      <LayoutInfluencer>
        <Filter className="flex items-center mb-2 md:mx-[15%]">
        ...
        <PhotosGalleryList models={models} />
      </LayoutInfluencer>
    </>
  );
}
