...
const LayoutInfluencer = dynamic(()=>import('views/shared/Layouts/LayoutInfluencer'),{ loading: () => <p>Loading ...</p> })
export default function TipMe() {
  const [money, setMoney] = useState('$ 24');
  
  function move(cant:any){
    setMoney(cant);
  }
          ...
          <div className="m-4">
            ...
            <div className="flex justify-between text-blue-450 font-bold my-8">
              <div className="text-blue-450 flex flex-col justify-end items-center">
                ...
                <button className='font-bold' onClick={() => move('$ 10')}>$10</button>
              </div>
              <div className="text-blue-450 flex flex-col justify-end items-center">
                <button className="bg-maf-green hidden text-white font-medium text-xs rounded-xl px-2 py-1">
                  Popular
                </button>
                <button className='font-bold' onClick={() => move('$ 20')}>$20</button>                
              </div>
              <div className="text-black flex flex-col items-center">
                <button className="bg-maf-green  text-white font-medium text-xs rounded-xl px-2 py-1">
                  Popular
                </button>
                <button className='font-bold' onClick={() => move('$ 24')}>$24</button>
              </div>
              <div className="text-blue-450 flex flex-col justify-end items-center">
                <button className="bg-maf-green hidden text-white font-medium text-xs rounded-xl px-2 py-1">
                  Popular
                </button>
                <button className='font-bold' onClick={() => move('$ 50')}>$50</button>
              </div>
              <div className="text-blue-450 flex flex-col justify-end items-center">
                <button className="bg-maf-green hidden text-white font-medium text-xs rounded-xl px-2 py-1">
                  Popular
                </button>
                <button className='font-bold' onClick={() => move('$ 100')}>$100</button>
              </div>
            </div>
          </div>
          <form className="px-2">
